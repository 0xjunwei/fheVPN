...
(0, config_1.subtask)(task_names_1.TASK_VERIFY_GET_VERIFICATION_SUBTASKS, async (_, { config, userConfig }) => {
    ...
    if (!config.etherscan.enabled &&
        ...
        console.warn(chalk_1.default.yellow(`[WARNING] No verification services are enabled. Please enable at least one verification service in your configuration.`));
    }
